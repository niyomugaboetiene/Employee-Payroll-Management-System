        ...
        <div className="bg-gray-100 min-h-screen">
            <div className="bg-white h-18 flex justify-between">
                ...
                <nav className="sm:gap-1 gap-2 flex justify-center flex-wrap md:gap-6 pt-4 text-xl font-light text-gray-700">
                    <Link className="hover:border-b border-gray-600">Home</Link>
                    <Link className="hover:border-b border-gray-600">Employees</Link>
                    <Link className="hover:border-b border-gray-600">Department</Link>
                    <Link className="hover:border-b border-gray-600">Salary</Link>
                    <Link className="hover:border-b border-gray-600">Payroll Report</Link>
                </nav>
